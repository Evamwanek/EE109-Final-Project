...
#pragma HLS INTERFACE ap_ctrl_hs port=return
 ...
 VITIS_LOOP_35_1: for (int f = 0; f < 50; f++) {
    VITIS_LOOP_36_2: for (int i = 0; i < 1024; i++) {
#pragma HLS PIPELINE II=1
 output_real[f * 1024 + i] = input_real[f * 1024 + i];
        output_imag[f * 1024 + i] = input_imag[f * 1024 + i];
    }
}
 }}
