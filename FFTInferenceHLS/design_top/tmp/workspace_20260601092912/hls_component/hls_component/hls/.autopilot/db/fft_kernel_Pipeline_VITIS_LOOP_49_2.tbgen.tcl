set moduleName fft_kernel_Pipeline_VITIS_LOOP_49_2
set isTopModule 0
...
set C_modelName {fft_kernel_Pipeline_VITIS_LOOP_49_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_imag","offset": { "type": "dynamic","port_name": "input_imag","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_real","offset": { "type": "dynamic","port_name": "input_real","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln47", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln47_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln47 sc_in sc_lv 62 signal 2 } 
	{ sext_ln47_1 sc_in sc_lv 62 signal 3 } 
	{ real_r_address1 sc_out sc_lv 10 signal 4 } 
	{ real_r_ce1 sc_out sc_logic 1 signal 4 } 
	{ real_r_we1 sc_out sc_logic 1 signal 4 } 
	{ real_r_d1 sc_out sc_lv 32 signal 4 } 
	{ imag_address1 sc_out sc_lv 10 signal 5 } 
	{ imag_ce1 sc_out sc_logic 1 signal 5 } 
	{ imag_we1 sc_out sc_logic 1 signal 5 } 
	{ imag_d1 sc_out sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln47_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln47_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "fft_kernel_Pipeline_VITIS_LOOP_49_2",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	fft_kernel_Pipeline_VITIS_LOOP_49_2 {
...
set Spec2ImplPortList { 
	...
	sext_ln47_1 { ap_none {  { sext_ln47_1 in_data 0 62 } } }
